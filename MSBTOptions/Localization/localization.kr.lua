...
obj["abbreviateSkills"]		= { label="짧은 주문/능력 이름", tooltip="주문/능력 이름을 짧게 표시해줍니다(영문).\n\n이 설정은 %sl 이벤트 코드를 사용한 이벤트에서 무시되어집니다."}
obj["hideSkills"]			= { label="주문/능력 이름 숨김", tooltip="받은, 대상이 받은 이벤트에서 주문/능력 이름을 표시하지 않습니다.\n\n이 옵션을 사용하면 %s 이벤트 코드를 무시하므로 이벤트에 대한 사용자 설정이 무시되어질 것입니다."}
...
obj["throttleList"]				= { label="주문/능력 출력시간", tooltip="명시한 주문/능력을 출력하는 단위시간을 설정하십시오."}
obj["mergeExclusions"]			= { label="병합 제외", tooltip="명시한 주문/능력을 병합에서 제외됩니다."}
obj["skillSuppressions"]		= { label="제외시킬 주문/능력", tooltip="제외시킬 주문/능력의 이름을 명시합니다."}
obj["skillSubstitutions"]		= { label="주문/능력 이름 대체", tooltip="주문/능력의 이름을 사용자가 입력한 글자로 대체합니다."}
...
obj["skillThrottleTime"]	= { label="출력시간 (초)", tooltip="주문/능력을 출력하는 단위시간 (초)."}
obj["cooldownThreshold"]	= { label="재사용 대기시간 기준", tooltip="주문/능력이 표시되기 위해 초과되어야 하는 재사용 대기시간의 기준 시간."}
...
--obj[12]	= { label="Skill DoT Crits", tooltip="Enable incoming skill damage over time crits."}
obj[13]	= { label="피해막 적중", tooltip="가시, 응보의 오라 등으로 자신이 받은 피해량을 활성화합니다."}
obj[14]	= { label="피해막 치명상", tooltip="가시, 응보의 오라 등으로 자신이 받은 치명상을 활성화합니다."}
obj[15]	= { label="주문/능력 빗맞힘", tooltip="자신에게 적중하지 않은 주문/능력 공격을 활성화합니다."}
obj[16]	= { label="기술 회피", tooltip="자신의 기술 회피를 활성화합니다."}
obj[17]	= { label="기술 막음", tooltip="자신의 기술 막음을 활성화합니다."}
obj[18]	= { label="기술 방어", tooltip="자신의 기술 방어를 활성화합니다."}
obj[19]	= { label="주문 저항", tooltip="자신의 주문 저항을 활성화합니다."}
obj[20]	= { label="주문/능력 흡수", tooltip="자신이 흡수한 주문/능력 피해량을 활성화합니다."}
obj[21]	= { label="주문/능력 면역", tooltip="자신에게 면역인 주문/능력 공격을 활성화합니다."}
obj[22]	= { label="주문/능력 반사", tooltip="자신이 반사한 주문/능력 피해량을 활성화합니다."}
obj[23]	= { label="주문 차단", tooltip="자신이 받은 주문 차단을 활성화합니다."}
obj[24]	= { label="치유", tooltip="자신이 받은 치유량을 활성화합니다."}
obj[25]	= { label="치유 극대화", tooltip="자신이 받은 치유 극대화를 활성화합니다."}
obj[26]	= { label="주기적 치유", tooltip="자신이 받은 주기적 치유를 활성화합니다."}
obj[27]	= { label="환경 피해", tooltip="자신이 받은 환경 피해 (낙하, 호흡, 용암 등...)를 활성화 합니다."}
...
--obj[12]	= { label="Skill DoT Crits", tooltip="Enable your pet's incoming skill damage over time crits."}
obj[13]	= { label="피해막 적중", tooltip="가시, 응보의 오라 등으로 소환수가 받은 피해량을 활성화합니다."}
obj[14]	= { label="피해막 치명상", tooltip="가시, 응보의 오라 등으로 소환수가 받은 치명상을 활성화합니다."}
obj[15]	= { label="주문/능력 공격 실패", tooltip="소환수에게 적중하지 않은 주문/능력 공격을 활성화합니다."}
obj[16]	= { label="기술 회피", tooltip="소환수의 기술 회피를 활성화합니다."}
obj[17]	= { label="기술 막음", tooltip="소환수의 기술 막음을 활성화합니다."}
obj[18]	= { label="기술 방어", tooltip="소환수의 기술 방어를 활성화합니다."}
obj[19]	= { label="주문 저항", tooltip="소환수의 주문 저항을 활성화합니다."}
obj[20]	= { label="주문/능력 흡수", tooltip="소환수가 흡수한 주문/능력 피해량을 활성화합니다."}
obj[21]	= { label="주문/능력 면역", tooltip="소환수에게 면역인 주문/능력 공격를 활성화합니다."}
obj[22]	= { label="치유", tooltip="소환수가 받은 치유량을 활성화합니다."}
obj[23]	= { label="치유 극대화", tooltip="소환수가 받은 치유 극대화를 활성화합니다."}
obj[24]	= { label="주기적 치유", tooltip="소환수가 받은 주기적 치유를 활성화합니다."}
...
--obj[13]	= { label="Skill DoT Crits", tooltip="Enable outgoing skill damage over time crits."}
obj[14]	= { label="피해막 적중", tooltip="가시, 응보의 오라 등으로 대상이 받은 피해량을 활성화합니다."}
obj[15]	= { label="피해막 치명타", tooltip="가시, 응보의 오라 등으로 대상이 받은 치명상을 활성화합니다."}
obj[16]	= { label="주문/능력 빗맞힘", tooltip="대상에게 적중하지 않은 주문/능력 공격을 활성화합니다."}
obj[17]	= { label="기술 회피", tooltip="기술 공격에 대한 대상의 회피를 활성화합니다."}
obj[18]	= { label="기술 막음", tooltip="기술 공격에 대한 대상의 막음을 활성화합니다."}
obj[19]	= { label="기술 방어", tooltip="기술 공격에 대한 대상의 방어를 활성화합니다."}
obj[20]	= { label="주문 저항", tooltip="주문 공격에 대한 대상의 저항을 활성화합니다."}
obj[21]	= { label="주문/능력 흡수", tooltip="주문/능력 공격에 대하여 대상이 흡수한 피해량을 활성화합니다."}
obj[22]	= { label="주문/능력 면역", tooltip="주문/능력 공격에 대한 대상의 면역을 활성화합니다."}
obj[23]	= { label="주문/능력 반사", tooltip="주문/능력 공격에 대하여 대상이 반사한 피해량을 활성화합니다."}
obj[24]	= { label="주문 차단", tooltip="대상이 받은 주문 차단을 활성화합니다."}
obj[25]	= { label="주문/능력 빗나감", tooltip="대상에게 빗나간 주문/능력 공격을 활성화합니다."}
obj[26]	= { label="치유", tooltip="대상이 받은 치유량을 활성화합니다."}
obj[27]	= { label="치유 극대화", tooltip="대상이 받은 치유 극대화를 활성화합니다."}
obj[28]	= { label="주기적인 치유", tooltip="대상이 받은 주기적 치유를 활성화합니다."}
obj[29] = { label="해제", tooltip="대상이 받은 해제를 활성화합니다."}
...
--obj[13]	= { label="Skill DoT Crits", tooltip="Enable outgoing skill damage over time crits."}
obj[14]	= { label="피해막 적중", tooltip="가시, 응보의 오라 등으로 소환수가 대상에게 준 피해량을 활성화합니다."}
obj[15]	= { label="피해막 치명타", tooltip="가시, 응보의 오라 등으로 소환수가 대상에게 준 치명상을 활성화합니다."}
obj[16]	= { label="주문/능력 빗맞힘", tooltip="대상에게 적중하지 않은 소환수의 주문/능력 공격을 활성화합니다."}
obj[17]	= { label="기술 회피", tooltip="소환수의 기술 공격에 대한 대상의 회피를 활성화합니다."}
obj[18]	= { label="기술 막음", tooltip="소환수의 기술 공격에 대한 대상의 막음을 활성화합니다."}
obj[19]	= { label="기술 방어", tooltip="소환수의 기술 공격에 대한 대상의 방어를 활성화합니다."}
obj[20]	= { label="주문 저항", tooltip="소환수의 주문 공격에 대한 대상의 저항을 활성화합니다."}
obj[21]	= { label="주문/능력 흡수", tooltip="소환수의 주문/능력 공격에 대하여 대상이 흡수한 피해량을 활성화합니다."}
obj[22]	= { label="주문/능력 면역", tooltip="소환수의 주문/능력 공격에 대한 대상의 면역을 활성화합니다."}
obj[23]	= { label="주문/능력 빗나감", tooltip="대상에게 빗나간 소환수의 주문/능력 공격을 활성화합니다."}
obj[24]	= { label="해제", tooltip="소환수의 해제를 활성화합니다."}
...
obj["SPELL_DAMAGE"]				= "기술 피해"
obj["GENERIC_DAMAGE"]			= "피해량"
obj["SPELL_PERIODIC_DAMAGE"]	= "주기적인 기술 피해 (DoT)"
...
obj["SPELL_MISSED"]				= "주문/능력 빗맞힘"
obj["GENERIC_MISSED"]			= "빗맞힘 (적중하지 않음)"
obj["SPELL_PERIODIC_MISSED"]	= "주기적인 주문/능력 빗맞힘"
...
obj["skillID"]				= "주문/능력 ID"
obj["skillName"]			= "주문/능력 이름"
obj["skillSchool"]			= "주문/능력 속성"
obj["extraSkillID"]			= "추가 주문/능력 ID"
obj["extraSkillName"]		= "추가 주문/능력 이름"
obj["extraSkillSchool"]		= "추가 주문/능력 속성"
obj["amount"]				= "수치 (양)"
...
obj["unavailableSkill"]		= "배우지 않은 주문/능력"
