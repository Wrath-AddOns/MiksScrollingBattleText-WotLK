...
obj["INCOMING_SPELL_DAMAGE_SHIELD_CRIT"]	= { label="Криты Ранящиего щита", tooltip="Вкл/Выкл входящий крит Ранящиего щита."}
...
--obj["PET_INCOMING_SPELL_DOT_CRIT"]				= { label="Skill DoT Crits", tooltip="Enable incoming skill damage over time crits."}
obj["PET_INCOMING_SPELL_DAMAGE_SHIELD"]			= { label="Удары Ранящиего щита", tooltip="Вкл/Выкл входящий урон по вашему питомцу от Ранящиего щита."}
...
obj["OUTGOING_SPELL_DOT"]					= { label="УзВ Заклинания", tooltip="Вкл/Выкл исходящие заклинания наносящие урон за время."}
--obj["OUTGOING_SPELL_DOT_CRIT"]				= { label="Skill DoT Crits", tooltip="Enable outgoing skill damage over time crits."}
obj["OUTGOING_SPELL_DAMAGE_SHIELD"]			= { label="Удары Ранящиего щита", tooltip="Вкл/Выкл исходящий урон от Ранящиего щита."}
obj["OUTGOING_SPELL_DAMAGE_SHIELD_CRIT"]	= { label="Криты Ранящиего щита", tooltip="Вкл/Выкл исходящий крит от Ранящиего щита."}
...
obj["PET_OUTGOING_SPELL_DAMAGE_SHIELD"]			= { label="Удары Ранящиего щита", tooltip="Вкл/Выкл исходящий урот вашего питомца от Ранящиего щита."}
obj["PET_OUTGOING_SPELL_DAMAGE_SHIELD_CRIT"]	= { label="Криты Ранящиего щита", tooltip="Вкл/Выкл исходящий крит вашего питомца от Ранящиего щита.."}
...
obj["NOTIFICATION_NPC_KILLING_BLOW"]	= { label="НПЦ Победный удар", tooltip="Вкл/Выкл оповещение когда вы рядом с НПЦ получаете Победный удар."}
obj["NOTIFICATION_SOUL_SHARD_CREATED"]	= { label="Получ. Камня Душ", tooltip="Вкл/Выкл оповещение когда вы получаете  камень душ."}
obj["NOTIFICATION_EXTRA_ATTACK"]		= { label="Экста Атаки", tooltip="Вкл/Выкл оповещение когда вы получаете дополнительные атаки такие как Ярость ветра, thrash, sword spec, и т.д."}
...
obj["NOTIFICATION_MONSTER_EMOTE"]		= { label="Эмоции Монстов", tooltip="Вкл/Выкл эмоции монстров которые в текущий момент в цели."}
